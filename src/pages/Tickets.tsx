    ...
    <Layout>
      ...
      <div className="bg-purple py-8">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold text-white">Bilhetes Disponíveis</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <span className="font-bold ml-2">{totalSelectedTickets} bilhetes</span>
              <span className="mx-2 text-gray-400">|</span>
              <span className="text-sm text-gray-600">Total:</span>
              <span className="font-bold ml-2">R$ {totalValue.toFixed(2).replace('.', ',')}</span>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          {filteredTickets.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">Nenhum bilhete encontrado com os filtros aplicados.</p>
              <Button 
                variant="link" 
                onClick={() => {
                  setSearchQuery('');
      ...
      <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Você está comprando {totalSelectedTickets} bilhete(s) por R$ {totalValue.toFixed(2).replace('.', ',')}.
            </DialogDescription>
          </DialogHeader>
            ...
            <TabsContent value="pix" className="space-y-4">
              <div className="flex flex-col items-center p-4 border rounded-md bg-gray-50">
                <div className="w-48 h-48 bg-gray-200 flex items-center justify-center mb-4">
                  <p className="text-center text-sm text-gray-500">QR Code PIX</p>
                </div>
                ...
                <p className="text-xs text-gray-500">
                  Após o pagamento, seus bilhetes serão automaticamente confirmados em até 1 minuto.
                </p>
              </div>
            </TabsContent>
