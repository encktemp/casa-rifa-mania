...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-purple-dark to-purple py-16 md:py-24">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-t-4 border-purple">
              <CardContent className="pt-6">
                <div className="flex items-center justify-center w-12 h-12 bg-purple-light text-purple rounded-full mb-4">
      ...
      {/* Stats Section */}
      <section className="py-12 bg-purple text-white">
        <div className="container mx-auto px-4">
